...
void flb_test_resource_k8s_container_custom_tag_regex()
{
    int ret;
    int size = sizeof(K8S_CONTAINER_NO_LOCAL_RESOURCE_ID) - 1;
    flb_ctx_t *ctx;
    ...
    flb_output_set(ctx, out_ffd,
                   ...
                   "k8s_cluster_name", "test_cluster_name",
                   "k8s_cluster_location", "test_cluster_location",
                   "custom_regex", "^(?<namespace_name>[^_]+)\\.(?<pod_name>[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*)\\.(?<container_name>.+)$",
                   NULL);
...
void flb_test_resource_k8s_container_custom_tag_regex_custom_prefix()
{
    int ret;
    int size = sizeof(K8S_CONTAINER_NO_LOCAL_RESOURCE_ID) - 1;
    flb_ctx_t *ctx;
...
TEST_LIST = {
    ...
    {"resource_k8s_container_custom_tag_regex", flb_test_resource_k8s_container_custom_tag_regex },
    {"resource_k8s_container_custom_tag_regex_custom_prefix", flb_test_resource_k8s_container_custom_tag_regex_custom_prefix },
